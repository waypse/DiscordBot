...
exports.default = (client) => {
    client.on("guildMemberAdd", (member) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield schema_1.default.findOne({ guildId: member.guild.id, userId: member.id, type: 'mute', });
        if (result) {
    ...
    const check = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const results = yield schema_1.default.find(query);
        ...
        yield schema_1.default.deleteMany(query);
